...
public partial class MainPage : ContentPage
{
    ...
    void OptOutToggled(object sender, Microsoft.Maui.Controls.ToggledEventArgs e)
    {
        App.localytics.OptedOut = ((Switch)sender).IsToggled;
        RefreshBackgroundProperties();
    }

    void TestModeToggled(object sender, Microsoft.Maui.Controls.ToggledEventArgs e)
    {
        Task.Run(() =>
        {
    ...
    void PlacesDisplayToggled(object sender, Microsoft.Maui.Controls.ToggledEventArgs e)
    {
        App.platform.SetPlacesShouldDisplay(((Switch)sender).IsToggled);
    }

    void InappDisplayToggled(object sender, Microsoft.Maui.Controls.ToggledEventArgs e)
    {
        App.platform.SetInAppShouldDisplay(((Switch)sender).IsToggled);
    }

    void DeepLinkToggled(object sender, Microsoft.Maui.Controls.ToggledEventArgs e)
    {
